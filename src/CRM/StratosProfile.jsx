...
//               StratosGoldwind
//               <span className="ml-2 text-yellow-600 text-sm font-semibold bg-yellow-100 px-2 py-0.5 rounded">
//                 🪙 Gold
//               </span>
//               <span className="ml-2 text-green-700 text-sm font-semibold bg-green-100 px-2 py-0.5 rounded">
//                 Profit-generator
//               </span>
//             </h1>
//           </div>
...
//           Mi sistema de trading utiliza un indicador propio para identificar con
//           precisión los puntos de reversión de la tendencia y la configuración
//           automática de lotes para optimizar las operaciones con riesgos mínimos.
//           Los resultados de las pruebas mostraron ganancias estables y un alto
//           porcentaje de operaciones exitosas, lo que hace que el sistema sea
//           efectivo para un trading constante.
//         </p>
//       </div>
...
//                     🪙 Gold / US Dollar <span className="text-sm">(spot)</span>
//                   </p>
//                 </div>
//               </div>
//               <div className="flex items-center gap-8 text-sm sm:text-base mt-2 sm:mt-0">
//                 <p className="text-gray-600">Invested: <b>3.00 $</b></p>
//                 <p className="text-gray-600">Leverage: <b>x100</b></p>
//                 <p className="text-green-600 font-semibold">+2.85 $</p>
//                 <p className="text-gray-400">1 minute ago</p>
//               </div>
//             </div>
//           ))}
//         </div>
