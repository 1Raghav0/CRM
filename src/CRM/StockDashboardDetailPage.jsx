...
// const StockDashboardDetailPage = () => {
//   const { state } = useLocation();
//   const { symbol } = useParams();
//   const navigate = useNavigate();

//   const gotoTopUp = () => navigate("/money/deposit", {state : {from: StockDashboardDetailPage.symbol} });
...
//   const investment = (lots * 432).toFixed(2);

//   return (
    
//     <div className="bg-gray-50 min-h-screen p-6 md:p-10">
//       <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
//         {/* LEFT SIDE - ASSET DETAILS + CHART */}
...
//                 }`}
//               >
//                 {isPositive ? "Top Gainer" : "Top Loser"}
//               </span>
//             </div>
...
//               <p>
//                 {asset.name} ({asset.symbol}) has recently shown{" "}
//                 {isPositive ? "positive" : "negative"} momentum in the market.
//                 The chart above displays a simulated short-term price trend for
//                 this asset. You can analyze and open a trade using the panel on
//                 the right.
//               </p>
//             </div>
//           </div>
...
// export default StockDashboardDetailPage;
...
const StockDashboardDetailPage = () => {
  ...
  const gotoTopUp = () =>
    navigate("/money/deposit", { state: { from: symbol || "unknown" } });
  ...
  // Related assets list (example) — include symbol for navigation
  const relatedAssets = [
  ...
  // Adjust route '/stock/:symbol' if your app uses a different path (e.g. /asset/:symbol).
  const openRelatedAsset = (related) => {
    navigate(`/stock/${related.symbol}`, { state: related });
  };
