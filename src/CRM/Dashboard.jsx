    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-black text-white p-6 rounded-lg shadow-lg flex items-center gap-8 ">
          <div className="flex flex-col">
            ...
            <p className="mb-4">Learn more about trading with a course from our partners at nomo academy</p>
          </div>
          <img src="./academy.webp" alt="Nomo Academy" className="w-32 h-28 object-cover rounded-full" />
        </div>
        ...
        <div className="bg-blue-800 text-white p-6 rounded-lg shadow-lg flex items-center gap-8">
          <div className="flex flex-col">
            ...
            <p className="mb-4">Get access to free articles, videos, and trading educational content</p>
          </div>
          <img src="educational.webp" alt="Educational Hub" className="w-32 h-28 object-cover rounded-full" />
        </div>
        ...
        <div className="bg-blue-500 text-white p-6 rounded-lg shadow-lg flex items-center justify-between">
          ...
          <img src="./economic.webp" alt="Economic Calendar" className="w-32 h-32 object-cover rounded-full" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
          <h4 className="text-xl font-semibold mb-2">My portfolio value</h4>
          <p className="text-4xl font-bold text-gray-800 mb-4">0.00</p>
          <button className="bg-blue-600 text-white py-2 px-4 rounded-full">Go to portfolio</button>
        </div>

        {/* Open Trades */}
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
          <h4 className="text-xl font-semibold mb-2">Open trades</h4>
          <p className="text-gray-600 mb-4">You have no open trades</p>
          <button className="bg-blue-600 text-white py-2 px-4 rounded-full">Trade now</button>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
          ...
          <button className="bg-blue-600 text-white py-2 px-4 rounded-full">Go to copy-trading</button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Your copy-trading activity will appear here, find a trader to copy now
          </p>
