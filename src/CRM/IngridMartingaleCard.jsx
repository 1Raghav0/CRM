...
//           Ingrid Martingale es un sistema de trading poderoso y rentable que opera con el par GBP/USD, generando ganancias reales con riesgos mínimos. Desde su lanzamiento en julio de 2024, el sistema ha mostrado una excelente ganancia neta. La estrategia de Martingala, combinada con algoritmos avanzados, permite obtener ganancias de manera constante, incluso en mercados volátiles.
//         </p>
//         <p className="text-gray-700 leading-relaxed text-sm sm:text-base mt-3">
//           Resultados: más del 80% de las operaciones son ganadoras, con una ganancia máxima por operación superior a los 2000 USD. Además, el sistema funciona tanto en posiciones largas como cortas.
//         </p>
//         <p className="text-gray-700 leading-relaxed text-sm sm:text-base mt-3">
//           Nuestro proyecto es la opción ideal para aquellos que buscan resultados reales sin riesgos innecesarios. Ha sido desarrollado por traders experimentados y ya ha demostrado su efectividad en la práctica. ¡Tus inversiones están en buenas manos!
//         </p>
//       </div>
//     </div>
//   );
...
//           mínimos. Desde su lanzamiento en julio de 2024, el sistema ha mostrado
//           una excelente ganancia neta.
//         </p>
//         <p className="text-gray-700 leading-relaxed text-sm sm:text-base mt-3">
//           Resultados: más del 80% de las operaciones son ganadoras, con una
//           ganancia máxima por operación superior a los 2000 USD. Además, el
//           sistema funciona tanto en posiciones largas como cortas.
//         </p>
//         <p className="text-gray-700 leading-relaxed text-sm sm:text-base mt-3">
//           Nuestro proyecto es la opción ideal para aquellos que buscan
//           resultados reales sin riesgos innecesarios. ¡Tus inversiones están en
//           buenas manos!
//         </p>
//       </div>
...
//             <button className="px-4 py-1 border-r bg-blue-600 text-white rounded-l-md">
//               Open trades
//             </button>
//             <button className="px-4 py-1 text-gray-600 hover:bg-gray-100 rounded-r-md">
//               Closed trades
//             </button>
//           </div>
//         </div>
...
//                   <td>{t.invested}</td>
//                   <td>{t.leverage}</td>
//                   <td className="text-green-600 font-semibold">{t.profitLoss}</td>
//                   <td className="text-gray-500">{t.openTime}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
