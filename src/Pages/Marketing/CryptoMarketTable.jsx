      ...
      <table className="w-full min-w-[700px] text-left">
        ...
        <tbody>
          {cryptoData.map((item, index) => (
            <tr key={index} className="border-b last:border-none hover:bg-gray-50 dark:hover:bg-gray-800 transition">
              <td className="py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 flex items-center gap-1">
                    {item.symbol}
                    <span className="bg-yellow-100 text-yellow-700 text-[10px] px-1.5 py-0.5 rounded">
                      Crypto
                    </span>
                  </p>
                </div>
