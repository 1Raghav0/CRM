...
// import PopupModal from "../Leaderboard/PopupModal";
...
const CopierDashboard = () => {
  ...
  // Navigation handlers
  const gotoDiscoverTraders = () => navigate("/copy-trading/leaderboard");
  const gotoBecomeLeadTrader = () => navigate("/copy-trading/leader-onboarding");
  const gotoArrow = () => navigate("/user-levels");
  const gotoArrow2 = () => navigate("/portfolio/open");
    ...
    <>
      <div className="bg-gray-50 p-4 sm:p-6 lg:p-10">
        ...
        <div className="flex flex-col flex-wrap gap-y-4 sm:flex-row sm:items-center sm:justify-between mb-8">
          ...
          <button
            className="mt-4 sm:mt-0 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-2.5 rounded-md"
            onClick={gotoDiscoverTraders}
          >
            Discover other traders
          </button>
      ...
      <div className="bg-gray-50 p-4 sm:p-6 lg:p-10">
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
          ...
          <div className="flex flex-col items-center justify-center text-center py-12">
            ...
            <button
              className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-5 py-2.5 rounded-md"
              onClick={gotoDiscoverTraders}
            >
              + Explore leaderboard
            </button>
